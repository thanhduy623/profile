...
export default {
    experienceList: [
        ...
        { name: "C++", point: 65, description: "Nền tảng", img: createUrl("c") },
        ...
        { name: "Postgre", point: 65, description: "Nền tảng", img: createUrl("postgresql") },
        { name: "Android studio", point: 65, description: "Nền tảng", img: createUrl("androidstudio") },
        { name: "n8n", point: 70, description: "Nghiên cứu", img: createUrl("n8n") },
    ]
}
