...
<script setup>
    ...
    import SectionAchievement from '@/components/sections/SectionAchievement.vue'

    const { currentLang, localizedData: organizationList, toggleLanguage } = useLocalizedData('organization.organizationList')
</script>